...
export const FooterComponent = () => {
    return (
        <footer className="group z-50 w-full text-sm text-neutral-600 animate-in fade-in-25 dark:text-neutral-400 bg-white/60 backdrop-blur-md dark:bg-neutral-900/60 fixed bottom-0 py-4">
